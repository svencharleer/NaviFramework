...
function RotatingTile(name, layer, position, size, style, events)
{
	...
	this.animatable = new NCAnimatable(["rotatingtile"]);
...
var tile2 = new RotatingTile("tile2", 2, {x: 200, y:200}, {w:50, h:50}, "square", {mouseDownEvent: customEvent_MouseDown, fingerEvent: customEvent_MouseDown})
